...
//        Assertions.assertEquals(1971, sector.getYearWithHighestEmissions() );
//    }
//    @Test
//    public void testYearWithHighestEmissions02() {
//        // Create the testable Sector object
//        Map<Integer, Emission> emissions = new HashMap<>();
//        // emissions.put(1970, Emission.put(co2: 288000.0, n2o: 684000.0, ch4: 4690000.0));
//        // emissions.put(1971, 2356.43);
//        // emissions.put(1972, 2243.3);
//        emissions.put(1970, new part2.Emission(100.0, 100.0, 100.0));
//        emissions.put(1971, new part2.Emission(120.0, 100.0, 100.0));
//
//        part2.Country country = new part2.Country("United States", emissions);
//
//        // Check that the method works as expected
//        Assertions.assertEquals(1971,country.getYearWithHighestEmissions() );
//    }
//
//}
